...
| Test depth | 755 tests across 38 files after the submission-assets proof test; frozen benign corpus and curated malicious corpus. | Covered |
| Precision honesty | `docs/precision-report.md` reports 36% SIGN, 64% HOLD, 0% false-REJECT on the frozen benign corpus. | Covered |
